...
export const ProductCard = ({
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      prevLikedRef.current = isLikedRef.current;
  ...
  const cardStyle =
    variant === "large" ? styles.productCardLarge : styles.productCard;
  const imageStyle =
    variant === "large"
      ? styles.productCardImageLarge
      : styles.productCardImage;
  const emojiStyle =
    variant === "large"
      ? styles.productCardEmojiLarge
      : styles.productCardEmoji;
...
export const ProductCardSkeleton = ({
  ...
  return (
    <Animated.View
      style={[styles.card, styles.productCard, style, animatedStyle]}
    >
      {/* Image Placeholder */}
