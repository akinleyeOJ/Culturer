    ...
    <View style={styles.stepContainer}>
        ...
        {cartItems.map((item) => (
          <View key={item.id} style={styles.reviewItem}>
            ...
            <Text style={styles.reviewItemPrice}>
              {formatPln(item.product.price * item.quantity)}
            </Text>
          </View>
        ))}
      </View>
      ...
      <View style={styles.section}>
        <View style={styles.costRow}>
          ...
          <Text style={styles.costValue}>{formatPln(totals.subtotal)}</Text>
        </View>
        {appliedDiscount && (
          <View style={styles.costRow}>
            <Text style={[styles.costLabel, { color: Colors.success[500] }]}>
              Discount
            </Text>
            <Text style={[styles.costValue, { color: Colors.success[500] }]}>
              - {formatPln(totals.discount)}
            </Text>
          </View>
        )}
        <View style={styles.costRow}>
          <Text style={styles.costLabel}>Shipping</Text>
          <Text style={styles.costValue}>{formatPln(totals.shippingCost)}</Text>
        </View>
        <View style={[styles.costRow, styles.totalRow]}>
          <Text style={styles.totalLabel}>Total To Pay</Text>
          <Text style={styles.totalValue}>{formatPln(totals.total)}</Text>
        </View>
      </View>
