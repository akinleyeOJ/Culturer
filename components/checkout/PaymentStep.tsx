    ...
    <View style={styles.stepContainer}>
      <View style={styles.section}>
        ...
        <TouchableOpacity
          style={[
            styles.radioOption,
            selectedPaymentMethod === "apple_pay" && styles.radioOptionSelected,
          ]}
            ...
            >
              ...
              <View>
                ...
                <Text style={styles.radioSubtitle}>
                  Finalise payment with Apple Pay
                </Text>
              </View>
            </View>
          </View>
        ...
        {country === "Poland" && (
          <TouchableOpacity
            style={[
              styles.radioOption,
              selectedPaymentMethod === "p24" && styles.radioOptionSelected,
            ]}
              ...
              >
                <View
                  style={[
                    ...
                    { backgroundColor: "#d4145a", borderColor: "#d4145a" },
                  ]}
                >
                  <Text
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text
                    style={styles.radioSubtitle}
                    numberOfLines={1}
                    ellipsizeMode="tail"
                  >
                    Blik, bank transfers & more
                  </Text>
                </View>
              </View>
            </View>
        ...
        <TouchableOpacity
          style={[
            styles.radioOption,
            selectedPaymentMethod === "card" && styles.radioOptionSelected,
          ]}
          ...
          {!loadingCards && savedCards && savedCards.length > 0 && (
            <View style={{ marginBottom: 24 }}>
              ...
              <TouchableOpacity
                style={[
                  styles.radioOption,
                  selectedSavedCardId === null && styles.radioOptionSelected,
                ]}
