...
import { formatPln, parseLoosePrice } from "../lib/formatPln";
...
const Cart = () => {
  ...
  const handleUpdateQuantity = async (
    ...
    if (success) {
      await Promise.all([refreshCartCount(), loadCart(true)]);
    }
    setUpdating(false);
  };
          ...
          <View key={sellerId} style={styles.sellerSection}>
              ...
              <View key={item.id} style={styles.cartItem}>
                ...
                <View style={styles.itemImage}>
                  {item.product.image_url || item.product.images?.[0] ? (
                    <Image
                      source={{
                        uri: item.product.image_url || item.product.images?.[0],
                      }}
            ...
            <View style={styles.sellerSubtotal}>
              ...
              <Text style={styles.subtotalAmount}>
                {formatPln(sellerGroup.subtotal)}
              </Text>
            </View>
            {sellerGroup.shipping > 0 && (
              <View style={styles.sellerSubtotal}>
                ...
                <Text style={styles.subtotalAmount}>
                  {formatPln(sellerGroup.shipping)}
                </Text>
              </View>
            )}
          </View>
                ...
                <View key={product.id} style={styles.complementCard}>
                  <View style={styles.complementImageContainer}>
                    {product.image_url || product.images?.[0] ? (
                      <Image
                        source={{
                          uri: product.image_url || product.images?.[0],
                        }}
                  ...
                  <Text style={styles.complementPrice}>
                    {formatPln(parseLoosePrice(product.price))}
                  </Text>
                </View>
              ))}
            </ScrollView>
      ...
      <View style={styles.bottomBar}>
        <View style={styles.totalSection}>
          <View style={styles.totalRow}>
            ...
            <Text style={styles.totalValue}>{formatPln(totals.subtotal)}</Text>
          </View>
          <View style={styles.totalRow}>
            <Text style={styles.totalLabel}>Shipping</Text>
            <Text style={styles.totalValue}>{formatPln(totals.shipping)}</Text>
          </View>
          <View style={[styles.totalRow, styles.grandTotalRow]}>
            <Text style={styles.grandTotalLabel}>Total</Text>
            <Text style={styles.grandTotalValue}>
              {formatPln(totals.total)}
            </Text>
          </View>
        </View>
