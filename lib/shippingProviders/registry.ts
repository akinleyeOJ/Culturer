...
const createSendcloudPickupAdapter = (
  providerName: string,
): ShippingProviderAdapter => ({
  providerKey: "generic",
  providerName,
...
const createInPostLockerAdapter = (
  providerName: string,
): ShippingProviderAdapter => ({
  providerKey: "inpost",
  providerName,
...
const SHIPPING_PROVIDER_ADAPTERS: Record<string, ShippingProviderAdapter> = {
  ...
  "dhl servicepoint locker": createSendcloudPickupAdapter(
    "DHL ServicePoint / Locker",
  ),
  ...
  "poste italiane punto poste": createSendcloudPickupAdapter(
    "Poste Italiane Punto Poste",
  ),
  ...
  "postnord pickup point": createSendcloudPickupAdapter(
...
export const getShippingProviderAdapter = (
  providerName: string,
